...
public class TurmaEntity {
    ...
    // Ajuste: não propagar REMOVE.
    //Quando apaga a Turma os Alunos dela não deixam de existir
    // Mantém apenas PERSIST/MERGE e orphanRemoval=false
    @OneToMany(
            mappedBy = "turma",
    ...
    public Set<AlunoEntity> getAlunos() { return alunos; }
    public void setAlunos(Set<AlunoEntity> s) { this.alunos = s; }
}
